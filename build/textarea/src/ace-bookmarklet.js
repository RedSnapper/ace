...
function setupApi(editor, editorDiv, settingDiv, ace, options, loader) {
    ...
    for (var option in options) {
        editor.setOption(option, options[option]);
    }
...
__ace_shadowed__.define('ace/mouse/default_gutter_handler', ['require', 'exports', 'module' , 'ace/lib/dom'], function(require, exports, module) {
...
__ace_shadowed__.define('ace/commands/default_commands', ['require', 'exports', 'module' , 'ace/lib/lang', 'ace/lib/dom'], function(require, exports, module) {
...
// Code for fullscreen - should probably be in its own file
...
__ace_shadowed__.define('ace/theme/textmate', ['require', 'exports', 'module' , 'text!ace/theme/textmate.css', 'ace/lib/dom'], function(require, exports, module) {
...
__ace_shadowed__.define("text!ace/theme/textmate.css", [], ".ace-tm .ace_editor {\n" +
